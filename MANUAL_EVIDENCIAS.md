...
## Paso 1: Control de Acceso y Seguridad (Capa de Presentación)
...
## Paso 2: Consola de Control e Integración con IBKR
...
## Paso 3: Motor Financiero Cuantitativo (Black-Scholes)
...
## Paso 4: Motor Algorítmico de Entrada (SMA Filter)
...
## Paso 4.5: Módulo de Backtesting Histórico (Data Science)
...
En el ejemplo visual inferior, se realiza la simulación retrospectiva sobre el ETF **SPY (SPDR S&P 500 ETF Trust)** utilizando un periodo de **SMA de 50 días** para maximizar la densidad de cruces y validar la velocidad de respuesta del filtro algorítmico.

![Simulación de Backtesting Histórico y Señales Algorítmicas](figures/fig_backtesting.png)

---

## Paso 5: Telemetría y Alertas en Tiempo Real
